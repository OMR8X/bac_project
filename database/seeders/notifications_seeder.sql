...
(6, 'تحفيز', 'محتوى تحفيزي عام', 'motivation', FALSE),
(6, 'تحفيز', '', 'advertising', FALSE),
(7, 'نظام', 'صيانة النظام وتحديثات الأمان والإعلانات المهمة', 'system', FALSE);
...
INSERT INTO user_notifications (user_id, notification_id, readed_at) VALUES
('25d773be-bb7c-4270-a94d-9767931ec085', 1, CURRENT_TIMESTAMP - INTERVAL '3 minutes'),  -- Welcome (updates) - Read
('25d773be-bb7c-4270-a94d-9767931ec085', 2, CURRENT_TIMESTAMP - INTERVAL '6 hours'),  -- New content (content) - Read
('25d773be-bb7c-4270-a94d-9767931ec085', 3, CURRENT_TIMESTAMP - INTERVAL '1 day'),  -- Performance insights (insights) - Read
('25d773be-bb7c-4270-a94d-9767931ec085', 4, CURRENT_TIMESTAMP - INTERVAL '5 hours'),  -- System maintenance (system) - Read
('25d773be-bb7c-4270-a94d-9767931ec085', 5, CURRENT_TIMESTAMP - INTERVAL '12 hours'),  -- Achievement (achievements) - Read
('25d773be-bb7c-4270-a94d-9767931ec085', 6, NULL);  -- Feedback request (feedback) - Not read
