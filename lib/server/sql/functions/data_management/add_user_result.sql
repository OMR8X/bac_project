CREATE OR REPLACE FUNCTION public.add_user_result(p_questions_ids integer[], p_duration_seconds integer, p_answers jsonb, p_lesson_id integer DEFAULT NULL::integer)
