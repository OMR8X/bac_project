...
class ColorsResourcesLight {
  //
  static const Color primary = Color(0xff3D3D3D);
  ...
  static const Color errorContainer = Color(0xffF15858);
  ...
  static const Color onSurface = Color(0xff4D4D4D);
  static const Color onSurfaceVariant = Color(0xff7E7E7E);
  //
  ...
  static const Color outlineVariant = Color(0xffE5E4E5);
  //
...
class ColorsResourcesDark {
  //
  static const Color primary = Color(0xff3D3D3D);
  static const Color primaryContainer = Color(0xff0556A8);
  static const Color onPrimary = Color(0xffF5F5F5);
  //
  ...
  static const Color onSurface = Color(0xffCECECE);
  static const Color onSurfaceVariant = Color(0xff565656);
  //
