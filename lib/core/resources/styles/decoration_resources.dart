...
class DecorationResources {
  ...
  static BoxDecoration tileBoxDecoration({required ThemeData theme}) {
    return BoxDecoration(
      ...
      boxShadow: [BoxShadow(color: theme.colorScheme.shadow, spreadRadius: 0, blurRadius: 5.77, offset: const Offset(2, 2))],
    );
  }

  static BoxDecoration inputFieldDecoration({required ThemeData theme}) {
    return BoxDecoration(color: theme.extension<SurfaceContainerColors>()?.surfaceContainerHigh, borderRadius: BorderRadiusResource.fieldBorderRadius);
  }

  static BoxDecoration inputDialogDecoration({required ThemeData theme}) {
    return BoxDecoration(color: theme.extension<SurfaceContainerColors>()?.surfaceContainer, borderRadius: BorderRadiusResource.fieldBorderRadius);
  }
}
