...
import '../../../features/results/domain/entities/answer_evaluation.dart';

class AnswerEvaluationsCardWidget extends StatelessWidget {
  const AnswerEvaluationsCardWidget({super.key, this.option, required this.answerEvaluation});
  final Option? option;
