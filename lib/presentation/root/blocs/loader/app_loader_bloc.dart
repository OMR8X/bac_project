...
import 'package:neuro_app/features/notifications/domain/usecases/get_device_token_usecase.dart';
...
import 'package:neuro_app/features/settings/domain/requests/get_app_settings_request.dart';
...
class AppLoaderBloc extends Bloc<AppLoader, AppLoaderState> {
  ...
  onAppLoaderLoadData(AppLoaderLoadData event, Emitter<AppLoaderState> emit) async {
    ...
    ///
    // await _codePushManager().initialize();
  }
